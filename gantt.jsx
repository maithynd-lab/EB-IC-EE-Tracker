                    ...
                    {isOpen && p.tasks.map((t) => {
                      ...
                      return (
                        <div className="gt-row gt-trow" key={t.id}>
                          ...
                          <div className="gt-track" style={gridBg}>
                            {t.deadline && inRange(t.deadline, range.start, range.end)
                              ? (() => {
                                  const pl = gPlace({ from: t.deadline, to: t.deadline, kind: 'dot' }, days);
                                  return pl ? (
                              ...
                              : <span className="gt-nodate">không có deadline</span>}
                            {days.indexOf(today) >= 0 && <span className="gt-today" style={{ left: ((days.indexOf(today) + 0.5) / N) * 100 + '%' }} />}
                          </div>
                        </div>
                      );
